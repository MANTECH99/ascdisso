...
<div class="max-w-md mx-auto p-6 mt-12">
    <div class="bg-white rounded-lg shadow-lg p-8">
        <div class="text-center mb-6">
            ...
            <p class="text-gray-600 text-sm mt-2">Saisissez votre code 2FA pour accéder au cashout</p>
        </div>
        ...
        <form action="{{ route('2fa.verify') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <p class="text-xs text-gray-500 mt-2 text-center">Code d'authentification</p>
                <p class="text-xs text-gray-400 mt-1 text-center">Entrez le code à 6 chiffres de votre application d'authentification</p>
            </div>
